...
self.location='asia.php?cat=' + val ;
}
...
<div id="right_holder"><img class="right" onclick ="slide(1)" src="right_arrow.png"/></div>  
        ...
        <div class="na"><a href="seccondpage2.html"><img src="asia.png" alt="Asia" style="width:60%;height:100%;"></a>
...
$quer2="SELECT DISTINCT countryid,countrname FROM countries where continid=1 order by countryid"; 
