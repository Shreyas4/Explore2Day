...
self.location='southamerica.php?cat=' + val ;
}
...
<div id="right_holder"><img class="right" onclick ="slide(1)" src="right_arrow.png"/></div>  
        ...
        <div class="na"><a href="seccondpage2.html"><img src="southamerica.png" alt="South America" style="width:40%;height:80%;"></a>
...
$quer2="SELECT DISTINCT countryid,countrname FROM countries where continid=4 order by countryid"; 
...
echo "<div class='sbutton'><input id='signup' type=submit value=Submit></div>";
echo "</form>";
?></body>
</html>