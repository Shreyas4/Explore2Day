...
self.location='europe.php?cat=' + val ;
}
...
<div id="right_holder"><img class="right" onclick ="slide(1)" src="right_arrow.png"/></div>  
        ...
        <div class="na"><a href="secondpage2.html"><img src="europe.png" alt="Europe" style="width:40%;height:80%;"></a>
...
$quer2="SELECT DISTINCT countryid,countrname FROM countries where continid=5 order by countryid"; 
...
echo  "<option value='$noticia[destname]'>$noticia[destname]</option><br><br></div><br>";
}
echo"<br/>";
