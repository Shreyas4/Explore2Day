...
self.location='northamerica.php?cat=' + val ;
}
...
<div id="right_holder"><img class="right" onclick ="slide(1)" src="right_arrow.png"/></div>  
        ...
        <div class="na"><a href="seccondpage2.html"><img src="northamerica.png" alt="North America" style="width:45%;height:70%;"></a>
...
$quer2="SELECT DISTINCT countryid,countrname FROM countries where continid=3 order by countryid"; 
