...
self.location='oceania.php?cat=' + val ;
}
...
<div id="right_holder"><img class="right" onclick ="slide(1)" src="right_arrow.png"/></div>  
        ...
        <div class="na"><a href="seccondpage2.html"><img src="oceania.png" alt="Oceania" style="width:45%;height:80%;"></a>
...
$quer2="SELECT DISTINCT countryid,countrname FROM countries where continid=6 order by countryid"; 
